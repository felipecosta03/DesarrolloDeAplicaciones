...
@Component
public class DefaultRetrieveMoviesByTitleApiRepository
    implements RetrieveMoviesByTitleApiRepository {
  private final WebClient webClient;
  private final FixMovie fixMovie;

  public DefaultRetrieveMoviesByTitleApiRepository(WebClient webClient, FixMovie fixMovie) {
