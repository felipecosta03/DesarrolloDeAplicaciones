...
@Component
public class DefaultIsAccessTokenValid implements IsAccessTokenValid {

  private final BuildJwtParser buildJwtParser;
  private final TokenRepository tokenRepository;

  public DefaultIsAccessTokenValid(BuildJwtParser buildJwtParser, TokenRepository tokenRepository) {
